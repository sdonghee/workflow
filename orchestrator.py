...
【필수 규칙 — 반드시 지킬 것】
1. 같은 블로그 내 포스팅들은 서로 완전히 다른 주제여야 합니다
   - 예: 유류할증료 뉴스가 있어도 → 1번=유류할증료, 2번=호텔/숙소 절약법, 3번=여행지 추천
   - 같은 뉴스 이벤트를 2개 이상 포스팅하면 절대 안 됨
2. topic_hint는 독자가 네이버에서 직접 검색할 법한 질문 형태로 구체적으로
3. 계절감·시사 반영하되 독자 실익 중심으로 (정보성 > 뉴스성)
4. 각 topic_hint는 다른 것들과 겹치지 않는 독립 주제
...
[
  {{
    "blog_key": "travel",
    "category": "여행_항공_호텔",
    "topic_hint": "4월 제주도 여행, 벚꽃 명소와 숙소 예약 꿀팁",
    "priority": 1
  }},
  {{
    "blog_key": "travel",
    "category": "여행_항공_호텔",
    "topic_hint": "동남아 항공권 유류할증료 인상, 지금 사는 게 맞나",
    "priority": 2
  }},
  {{
    "blog_key": "travel",
    "category": "여행_항공_호텔",
    "topic_hint": "가성비 해외여행 호텔 예약, 이렇게 하면 30% 싸다",
    "priority": 3
  }}
]"""
